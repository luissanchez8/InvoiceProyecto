...
<head>
    ...
    <style type="text/css">
        ...
        /* ============================================================
           ...
           ============================================================ */
        .header-table { width: 100%; padding: 20px 40px 12px 40px; }
        ...
        .header-invoice-meta { font-size: 11px; color: #555555; line-height: 1.35; margin-top: 3px; }

        /* ============================================================
           DATOS DEL EMISOR
           ============================================================ */
        .issuer-section { padding: 10px 40px 10px 40px; border-bottom: 1px solid #dddddd; }
        .issuer-details { font-size: 11px; color: #555555; line-height: 1.3; }
        .issuer-details h3 { font-size: 12px; font-weight: bold; color: #333333; margin: 0 0 2px 0; padding: 0; }
        .issuer-details p { margin: 0; padding: 0; line-height: 1.3; }

        /* ============================================================
           CLIENTE + ENVÍO
           ============================================================ */
        .addresses-table { width: 100%; padding: 12px 40px 8px 40px; }
        ...
        .address-label { font-size: 10px; font-weight: bold; color: #888888; margin-bottom: 1px; text-transform: uppercase; }
        .address-detail { font-size: 11px; color: #555555; line-height: 1.3; }
        .address-detail h3 { font-size: 12px; font-weight: bold; color: #333333; margin: 0 0 2px 0; padding: 0; }
        .address-detail p { margin: 0; padding: 0; line-height: 1.3; }
        ...
        .items-table thead th { background-color: #f5f5f5; font-size: 11px; font-weight: bold; color: #333333; padding: 6px 10px; border-top: 1px solid #dddddd; border-bottom: 1px solid #dddddd; text-transform: uppercase; }
        .items-table thead th.col-concept { text-align: left; width: 50%; }
        .items-table thead th.col-numeric { text-align: right; }
        .items-table tbody td { font-size: 11px; color: #333333; padding: 6px 10px; border-bottom: 1px solid #eeeeee; vertical-align: top; }
        ...
        .totals-table td.total-label { font-size: 11px; color: #555555; text-align: right; padding: 2px 15px 2px 10px; }
        .totals-table td.total-value { font-size: 11px; color: #333333; text-align: right; padding: 2px 0 2px 10px; white-space: nowrap; }
        .totals-table td.total-final-label { font-size: 13px; font-weight: bold; color: #333333; text-align: right; padding: 5px 15px 5px 10px; border-top: 1px solid #dddddd; }
        .totals-table td.total-final-value { font-size: 15px; font-weight: bold; color: #333333; text-align: right; padding: 5px 0 5px 10px; border-top: 1px solid #dddddd; white-space: nowrap; }

        /* ============================================================
           FOOTER, FIRMA, PAGINACIÓN
           ============================================================ */
        .footer-content { clear: both; padding: 18px 40px 8px 40px; page-break-inside: avoid; }
