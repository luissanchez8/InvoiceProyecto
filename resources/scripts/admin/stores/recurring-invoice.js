    ...
    actions: {
      ...
      async fetchRecurringInvoiceInitialSettings(isEdit) {
        ...
        if (!isEdit) {
          ...
          // v.1.9.4 — Onfactu: IVA 21% por defecto al crear factura recurrente.
          ...
          try {
            ...
            if (ivaDefault && this.newRecurringInvoice.taxes.length === 0) {
              this.newRecurringInvoice.taxes.push({
                id: ivaDefault.id,
