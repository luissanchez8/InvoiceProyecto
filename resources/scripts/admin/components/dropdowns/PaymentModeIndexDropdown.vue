<template>
  <BaseDropdown>
    ...
    <!-- delete paymentMode (solo asistencia) -->
    <BaseDropdownItem v-if="isAsistencia" @click="removePaymentMode(row.id)">
      <BaseIcon
        name="TrashIcon"
        class="w-5 h-5 mr-3 text-gray-400 group-hover:text-gray-500"
      />
...
// v.1.9.5 — Onfactu: solo asistencia puede borrar formas de pago
