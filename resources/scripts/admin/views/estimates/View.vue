          ...
          >
            <div class="flex-2">
              ...
              <div
                ...
                "
              >
                {{ estimate.estimate_number || $t('general.draft').toUpperCase() }}
              </div>
...
const pageTitle = computed(() =>
  // Onfactu: si es borrador sin número, mostrar BORRADOR.
  estimateData.value.estimate_number || t('general.draft').toUpperCase()
)
