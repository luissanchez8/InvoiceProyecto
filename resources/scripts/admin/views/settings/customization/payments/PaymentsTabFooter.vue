<template>
  <form @submit.prevent="submitForm">
    ...
    >
      <BaseTextarea
        v-model="footerSettings.payment_pdf_footer_text"
        rows="2"
      />
    </BaseInputGroup>
    ...
    >
      <BaseTextarea
        v-model="footerSettings.payment_pdf_legal_notice_text"
        rows="4"
      />
    </BaseInputGroup>
...
const footerSettings = reactive({
  payment_pdf_footer_text: '',
  payment_pdf_legal_notice_text: '',
})
