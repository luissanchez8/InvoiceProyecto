<template>
  <form @submit.prevent="submitForm">
    ...
    >
      <BaseTextarea
        v-model="footerSettings.proforma_pdf_footer_text"
        rows="2"
      />
    </BaseInputGroup>
    ...
    >
      <BaseTextarea
        v-model="footerSettings.proforma_pdf_legal_notice_text"
        rows="4"
      />
    </BaseInputGroup>
...
const footerSettings = reactive({
  proforma_pdf_footer_text: '',
  proforma_pdf_legal_notice_text: '',
})
