<template>
  <form @submit.prevent="submitForm">
    ...
    >
      <BaseTextarea
        v-model="footerSettings.estimate_pdf_footer_text"
        rows="2"
      />
    </BaseInputGroup>
    ...
    >
      <BaseTextarea
        v-model="footerSettings.estimate_pdf_legal_notice_text"
        rows="4"
      />
    </BaseInputGroup>
...
const footerSettings = reactive({
  estimate_pdf_footer_text: '',
  estimate_pdf_legal_notice_text: '',
})
