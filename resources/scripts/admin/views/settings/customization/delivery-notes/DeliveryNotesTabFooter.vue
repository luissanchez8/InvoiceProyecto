<template>
  <form @submit.prevent="submitForm">
    ...
    >
      <BaseTextarea
        v-model="footerSettings.deliverynote_pdf_footer_text"
        rows="2"
      />
    </BaseInputGroup>
    ...
    >
      <BaseTextarea
        v-model="footerSettings.deliverynote_pdf_legal_notice_text"
        rows="4"
      />
    </BaseInputGroup>
...
const footerSettings = reactive({
  deliverynote_pdf_footer_text: '',
  deliverynote_pdf_legal_notice_text: '',
})
...
async function submitForm() {
  ...
  await companyStore.updateCompanySettings({
    data,
    message: 'settings.customization.deliverynotes.deliverynote_settings_updated',
  })
