    ...
    <form @submit.prevent="submitForm">
      ...
      <div class="grid grid-cols-12 gap-8 mt-6 mb-8">
        ...
        <BaseInputGrid class="col-span-12 lg:col-span-7">
          ...
          >
            <BaseMultiselect
              v-model="proformaInvoiceStore.newProformaInvoice.payment_method_id"
              :content-loading="isLoadingContent"
...
const selectedPaymentMethodText = computed(() => {
  const id = proformaInvoiceStore.newProformaInvoice.payment_method_id
  if (!id) return ''
...
const paymentMethodOptions = computed(() => {
  return [
    { id: null, name: $t2('invoices.payment_method_none') },
